...
// it well before it finished. An hour matches what web apps already get. Note
// the per-app `timeout` field only reaches web sessions (see spawnWebSession) —
// a TUI session that must outlive the hour still has to be pinned.
